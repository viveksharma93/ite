<?php include 'header.php';?>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Become a RedHat Certified</h1>
                                    <h2 class="animation animated-item-2">We provide training and certifications on RedHat certified linux courses...</h2>
                ...
                <div class="item" style="background-image: url(images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Become a Certified Ethical Hacker</h1>
                                    <h2 class="animation animated-item-2">We provide the training on EC-Council ethical hacking courses...</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Get placed in a reputed company</h1>
                                    <h2 class="animation animated-item-2">We provide placement assistance to our Certified students...</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>Linux Training by RedHat Certified Instructor.</h3>
                        </div>
                    </div><!--/.col-md-4-->
    ...
    <section id="recent-works">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>Recent Works And Achievements</h2>
                <p class="lead">Check our recent training on linux, placement assistance to our students, consulting services to corporate sectors and our students who are successfully placed in various reputed company</p>
            </div>
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                ...
                                <p>Successfully delivered docker training to Wipro employees</p>
                        ...
                        <div class="panel-group" id="accordion1">
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             ...
                                             <p>We provide practical training on RedHat certified courses</p>
                                        </div>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                We give placement assistance to our certified students. Our students are placed in various reputed company like RedHat etc. We give 100% placement guarantee.
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                                We prepared our students for RedHat, EC-Council, CCNA certification exams. Our students give a 100% results on these exams.
                              </div>
                            </div>
                          </div>
                        </div><!--/#accordion1-->
                    ...
                    <div class="testimonial">
                        <h2>Testimonials</h2>
                         <div class="media testimonial-inner">
                            ...
                            <div class="media-body">
                                <p>I've attended Python class taught by Rohit Sir. It is the first time that I've learnt other basic concepts too along with the main content of the course which has helped me clear many basic doubts and concepts. I highly recommend attending the classes at ITE for enhancing knowledge in every aspect.</p>
                                <span><strong>-Sejal Varshney/</strong> Student</span>
                            </div>
                         </div>
                         ...
                         <!-- <div class="media testimonial-inner">
                            ...
                            <div class="media-body">
                                ...
                                <span><strong>-John Doe/</strong> Director of ITE.com</span>
                            </div>
                         </div> -->
    ...
    <section id="partner">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>Our Students </h2>
                <p class="lead">Our certified students are placed in various reputed company</p>
            </div>
                ...
                <div class="col-sm-8">
                    <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <div class="media-body">
                            ...
                            <p>If you have any query regarding training, placement assistance or consulting please give a missed call on this no +91-9111240646. We will callback you as soon as possible.</p>
                        </div>
                    </div>
                </div>
            </div>
